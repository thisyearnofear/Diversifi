...
export const farcasterActionSchema = z.object({
  ...
  description: z.string().default("Create a Farcaster account and join the decentralized social network"),
  ...
  proofFieldPlaceholder: z.string().default("https://warpcast.com/yourusername")
});
