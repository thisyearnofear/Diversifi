...
export function CeloPusoSwapCardCompact({
  isRegistered = false,
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              You've successfully swapped for PUSO on Celo!
            </p>
            {txHash && (
              <a
      ...
      <div className="p-4 bg-purple-50 dark:bg-purple-900/20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-medium">Swap to PUSO</h3>
                <Badge
                  variant="outline"
        ...
        {isExpanded && (
          <div className="mt-4 space-y-4">
            <div>
              <h4 className="text-sm font-medium mb-2">About PUSO:</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">
                PUSO is a Philippine Peso stablecoin on the Celo blockchain,
                providing a stable digital asset pegged to the Philippine Peso.
              </p>
              <div className="flex items-center text-xs text-blue-600">
                <a
                  href="https://explorer.celo.org/mainnet/token/0x105d4a9306d2e55a71d2eb95b81553ae1dc20d7b"
                  target="_blank"
                  rel="noopener noreferrer"
