  ...
  try {
    ...
    if (category) {
      ...
      if (validChains.includes(category.toUpperCase())) {
        ...
        const validCategories = ["SOCIAL", "DEFI", "NFT", "STABLECOIN", "TRADING", "REGISTRATION"];
    ...
    if (actions.length === 0) {
        ...
        "CELO": [
          {
            ...
            chain: "CELO",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Celo network", "Swap cUSD for PUSO"],
          ...
          },
          {
            ...
            description: "Get Colombian Peso stablecoins (cCOP) on the Celo blockchain",
            chain: "CELO",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Celo network", "Swap cUSD for cCOP"],
          ...
          },
          {
            ...
            chain: "CELO",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Celo network", "Swap cUSD for cKES"],
        ...
        "OPTIMISM": [
          {
            ...
            chain: "OPTIMISM",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Optimism network", "Complete registration"],
          ...
          },
          {
            ...
            chain: "OPTIMISM",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Optimism network", "Swap ETH for EURA"],
        ...
        "BASE": [
          {
            ...
            chain: "BASE",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Base network", "Complete registration"],
          ...
          },
          {
            ...
            chain: "BASE",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Base network", "Swap ETH for USDbC"],
        ...
        "POLYGON": [
          {
            ...
            chain: "POLYGON",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Polygon network", "Complete registration"],
          ...
          },
          {
            ...
            chain: "POLYGON",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Polygon network", "Swap MATIC for DAI"],
      ...
      const categoryFallbacks = {
        ...
        "REGISTRATION": [
          ...
          },
          {
            ...
            chain: "CELO",
            difficulty: "beginner",
            steps: ["Connect your wallet", "Switch to Celo network", "Complete registration"],
      ...
      if (category && chainFallbacks[category.toUpperCase() as keyof typeof chainFallbacks]) {
        return NextResponse.json(chainFallbacks[category.toUpperCase() as keyof typeof chainFallbacks]);
      }

      // If category is a valid category, return category-specific fallbacks
      if (category && categoryFallbacks[category.toUpperCase() as keyof typeof categoryFallbacks]) {
        return NextResponse.json(categoryFallbacks[category.toUpperCase() as keyof typeof categoryFallbacks]);
      }
    ...
    const actionData: ActionData[] = actions.map((a) => {
      ...
      return {
        ...
        proofFieldPlaceholder: a.proofFieldPlaceholder || defaultProofFields.placeholder,
      };
    });
